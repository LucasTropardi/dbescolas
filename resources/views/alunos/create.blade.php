                    ...
                    <form action="{{ route('aluno.store') }}" method="post">
                        ...
                        <fieldset class="border-2 rounded p-6">
                            ...
                            <div class="bg-gray-100 p-4 rounded overflow-hidden mb-2">
                                ...
                                <select name="sala_id" id="sala_id" class="w-full rounded" required>
                                    @foreach($salas as $sala)
                                        <option value="{{ $sala->id }}">{{ $sala->saNome }}</option>
                                    @endforeach
                                </select>
                            </div>
                            ...
                            <div class="bg-gray-100 p-4 rounded overflow-hidden mb-2">
                                ...
                                <input type="text" name="alNome" id="alNome" class="w-full rounded" required autofocus>
                            </div>

                            <div class="bg-gray-100 p-4 rounded overflow-hidden mb-2">
                                <label for="alNumero">Numero</label>
                                <input type="text" name="alNumero" id="alNumero" class="w-full rounded" pattern="[0-9]" maxlength="1">
                            </div>

                            <div class="bg-gray-100 p-4 rounded overflow-hidden mb-2">
                                <label for="alResponsavel">Responsável</label>
                                <input type="text" name="alResponsavel" id="alResponsavel" class="w-full rounded" required>
                            </div>

                            <div class="bg-gray-100 p-4 rounded overflow-hidden mb-2">
                                <label for="alTelefone">Telefone</label>
                                <input type="text" name="alTelefone" id="alTelefone" class="w-full rounded" required>
                            </div>

                            <div class="bg-gray-100 p-4 rounded overflow-hidden mb-2">
                                <label for="alEndereco">Endereço</label>
                                <input type="text" name="alEndereco" id="alEndereco" class="w-full rounded" required>
                            </div>

                            <div class="bg-gray-100 p-4 rounded overflow-hidden mb-2">
                                <label for="alCidade">Cidade</label>
                                <input type="text" name="alCidade" id="alCidade" class="w-full rounded" required>
                            </div>

                            <div class="bg-gray-100 p-4 rounded overflow-hidden mb-2">
                                <label for="alObs">Observação</label>
                                <input type="text" name="alObs" id="alObs" class="w-full rounded" required>
                            </div>
